...
The project combines mobile, backend integration, and service-support technologies.
The table below summarizes the major technology requirements.
...
It enables the system to validate user access for protected API endpoints while
supporting token refresh for longer user sessions.
...
#figure(
  align(center)[
    #box(
      ...
      fill: luma(248),
      [
        *Freezed / JSON Serializable Logo Placeholder*
